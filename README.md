...
> **Hệ thống AI dự đoán tương lai theo ngữ cảnh, phân rã vi bước kỹ thuật (5-15 phút), radar nhận diện điểm nghẽn và trợ lý ra quyết định Why-First tích hợp RAG ngữ nghĩa.**
...
### 2. ⚡ Micro-Steps Tracker & Nano-Step Decomposer
- Quản lý danh sách vi bước 5-15 phút gắn liền với nguyên lý lập trình viên.
...
- Liên kết vi bước trực tiếp với Cột mốc (Milestone) của Mục tiêu dài hạn.
...
### 7. 📊 Behavioral Analytics & Focus Metrics
- **Focus Efficiency Score**: Điểm số đo lường hiệu quả tập trung dựa trên tỷ lệ hoàn thành vi bước.
- **Decision Friction Index**: Chỉ số ma sát nhận thức cảnh báo nguy cơ kiệt sức.
- Gợi ý điều chỉnh hành vi theo mức năng lượng (High, Medium, Low).
...
| **Charts & Graphs** | Recharts, Motion | Biểu đồ trực quan hóa dữ liệu động, mượt mà |
...
│   ├── behavioral/              # Domain: Phân tích hành vi & hiệu suất tập trung
...
│   ├── prediction/              # Domain: Predictive Horizon View & usePrediction hook
│   ├── projectContext/          # Domain: Quản lý Context dự án & Modal cấu hình
│   ├── types/                   # Định nghĩa TypeScript models toàn hệ thống
...
2. **Theo dõi Drift Score**: Nếu điểm trôi dạt vượt quá 40%, hãy mở **Tầng 1 (Goal Canvas)** để gắn lại các vi bước vào đúng mục tiêu then chốt của Quý.
3. **Sử dụng Decision Copilot trước khi code**: Trước khi bắt đầu một đợt refactor lớn hoặc chọn thư viện mới, hãy nhập phân vân vào tab **"Quyết Định Why-First"** để nhìn rõ các đánh đổi và rủi ro tiềm ẩn.
